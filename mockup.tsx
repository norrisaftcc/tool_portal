...
import { Square, Trophy, Zap, Gift, Bell, Menu, Search, ChevronRight, User, LogIn } from 'lucide-react';
    ...
    <div className="bg-gray-900 text-white min-h-screen">
      ...
      <section className="relative">
        <div className="bg-gradient-to-r from-indigo-800 to-purple-800 px-4 py-8 md:py-12">
          <div className="max-w-lg mx-auto text-center">
            ...
            <button className="bg-gradient-to-r from-yellow-500 to-yellow-400 hover:from-yellow-400 hover:to-yellow-300 text-gray-900 font-bold px-6 py-3 rounded-full shadow-lg transition transform hover:scale-105">
              PLAY NOW
            </button>
        ...
        <div className="relative -mt-6 px-4 pb-4">
          <div className="flex overflow-x-auto pb-2 space-x-4 scrollbar-hide">
            {['Blackjack Blitz', 'Lucky Spin', 'Poker Rush', 'Roulette Fever'].map((game, index) => (
              <div 
                key={index} 
                className="relative flex-shrink-0 w-48 h-36 bg-gradient-to-br from-blue-600 to-purple-800 rounded-lg shadow-lg overflow-hidden"
              >
      ...
      <section className="px-4 py-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          {[
            { name: 'Card Games', icon: <div className="text-red-500"><span className="text-xl">♠️</span></div> },
            { name: 'Slots', icon: <div className="text-yellow-500"><Zap size={20} /></div> },
            { name: 'Table Games', icon: <div className="text-green-500"><span className="text-xl">🎲</span></div> },
            { name: 'Jackpots', icon: <div className="text-purple-500"><Trophy size={20} /></div> }
          ].map((category, index) => (
            <div 
              key={index} 
      ...
      <section className="px-4 py-6 bg-gradient-to-b from-gray-900 to-gray-800">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          {[
            { name: 'Quick Poker', multiplier: '5x', playing: 328 },
            { name: 'Lucky Spin', multiplier: '3x', playing: 412 },
            { name: 'Blackjack Pro', multiplier: '2x', playing: 256 },
            { name: 'Mega Slots', multiplier: '10x', playing: 189 },
            { name: 'Roulette Master', multiplier: '35x', playing: 145 },
            { name: 'Dice Rush', multiplier: '6x', playing: 203 }
          ].map((game, index) => (
            <div 
              key={index} 
            ...
            >
              ...
              <div className="p-3">
                ...
                <button className="mt-2 w-full bg-purple-600 hover:bg-purple-500 text-white py-1 rounded text-sm font-medium transition">
                  Play
                </button>
              </div>
            </div>
      ...
      <section className="px-4 py-6">
        <div className="bg-gradient-to-r from-blue-900 to-purple-900 rounded-xl p-4 relative overflow-hidden">
          <div className="relative z-10">
            ...
            <button className="bg-yellow-500 hover:bg-yellow-400 text-gray-900 font-bold px-4 py-2 rounded-lg text-sm transition">
              Claim Day 4 Bonus
            </button>
          </div>
